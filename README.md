...
1. Un solo hilo.  
![Thread](img/1 Thread.PNG)  
![ThreadGraph](img/1 Thread Grafica.PNG.PNG)  
...
![Thread](img/8 Thread.PNG)  
![ThreadGraph](img/8 Thread Grafica.PNG.PNG)  
3. Tantos hilos como el doble de núcleos de procesamiento. 16 hilos
![Thread](img/16 Thread.PNG)  
![ThreadGraph](img/16 Thread Grafica.PNG.PNG)  
4. 50 hilos.  
![Thread](img/50 Thread.PNG)  
![ThreadGraph](img/50 Thread Grafica.PNG.PNG)  
5. 100 hilos. 
![Thread](img/100 Thread.PNG)  
![ThreadGraph](img/100 Thread Grafica.PNG.PNG)  

Al iniciar el programa ejecute el monitor jVisualVM, y a medida que corran las pruebas, revise y anote el consumo de CPU y de memoria en cada caso. ![](img/jvisualvm.png)

Con lo anterior, y con los tiempos de ejecución dados, haga una gráfica de tiempo de solución vs. número de hilos. Analice y plantee hipótesis con su compañero para las siguientes preguntas (puede tener en cuenta lo reportado por jVisualVM):  
![Grafica](img/Grafica.PNG.PNG)  
